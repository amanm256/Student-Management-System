...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#0a0d36">
        <div class="container" >
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					 ...
					 <li style="color:#FFFFFF">
                        <a style="color:#FFFFFF" href="http://localhost/Student%20System"><i class="fa fa-home fa-fw"></i>Home</a>
                    </li>
					
					<li style="color:#FFFFFF">
                        <a style="color:#FFFFFF" href="http://localhost/Student%20System/"><i class="fa fa-home fa-fw"></i>About</a>
                    </li>
...
<!-- slider -->			
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#0a0d36">
