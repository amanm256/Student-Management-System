...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="dashboard.php?info=add_attendance"><i class="fa fa-plus fa-fw"></i> Add Attendance</a>
                                </li>
								 <li>
        ...
        <li>
			<a href="dashboard.php?info=course"><i class="fa fa-eye"></i> Course</a>
        </li>
        <li><a href="subjects.php"><i class="fa fa-eye"></i>Subjects</a></li>

        <li>
			<a href="dashboard.php?info=schedule"><i class="fa fa-eye"></i> Schedule</a>
     	</li>

                        <li>
                            <a href="#"><i class="fa fa-user fa-book"></i>Exam<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=exam"><i class="exam"></i> Exam</a>
                                </li>
								 <li>
                                    <a href="dashboard.php?info=display_exam"><i class="exam"></i> Manage Exam</a>
                                </li> 
                            </ul>
                        </li>
		
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Academic Year<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="dashboard.php?info=2023_2024"><i class="academic"></i> 2023-2024</a>
                                </li>
                                <li>
                                    <a href="dashboard.php?info=2024_2025"><i class="academic"></i> 2024-2025</a>
                                </li>
                                 <li>
                                    <a href="dashboard.php?info=2025_2026"><i class="academic"></i> 2025-2026</a>
                                </li>
								 <li>
                                    <a href="dashboard.php?info=display_academic"><i class="academic"></i> Manage Academic </a>
                                </li> 
                            </ul>
                        </li>
                ...
                <div class="col-lg-12">
                	...
                	<?php 
								...
								if($info!="")
								{
                                    ...
                                    elseif($info=="display_exam")   
                                        {
                                            include('display_exam.php');
                                        }
                                    ...
                                    elseif($info=="academic_year")
                                        {
                                            include('2024_2025.php');
                                        }
                                    elseif($info=="academic_year")
                                        {
                                            include('2025_2026.php');
                                        }
                                    elseif($info=="display_academic")
                                        {
                                            include('display_academic.php');
                                        }
